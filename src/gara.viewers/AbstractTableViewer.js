...
gara.provide("gara.viewers.AbstractTableViewer", "gara.viewers.ColumnViewer");
 ...
 */
gara.Class("gara.viewers.AbstractTableViewer", function () { return {
	$extends : gara.viewers.ColumnViewer,
	...
	createItem : function (element, index) {
		this.updateItem(this.internalCreateNewRowPart(gara.NONE, index).getItem(), element);
	},
	...
	doUpdateItem : function (widget, element) {
		...
		if (widget instanceof gara.widgets.Item) {
			item = widget;
