...
gara.provide("gara.viewers.AbstractListViewer", "gara.viewers.StructuredViewer");


/**
 * @class AbstractListViewer
 * @extends gara.StructuredViewer
 * @namespace gara.viewers
 * @author Thomas Gossmann
 */
gara.Class("gara.viewers.AbstractListViewer", function () { return {
...
//						items.removeAt(i);
			...
			if (min < elementChildren.length) {
				for (i = min; i < elementChildren.length; ++i) {
					...
					item = this.createListItem(elementChildren[i], gara.DEFAULT, i);
