...
gara.provide("gara.viewers.TreeViewerRow", "gara.viewers.ViewerRow");
 ...
 */
gara.Class("gara.viewers.TreeViewerRow", function () { return {
	$extends : gara.viewers.ViewerRow,

	$constructor : function ( item) {
		if (!(item instanceof gara.widgets.TreeItem)) {
			throw new TypeError("item is not instance of gara.widgets.TreeItem");
		}
		this.item = item;
	},
