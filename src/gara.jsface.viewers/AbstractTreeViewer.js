...
gara.provide("gara.jsface.viewers.AbstractTreeViewer", "gara.jsface.viewers.ColumnViewer");
 ...
 */
gara.Class("AbstractTreeViewer", function () { return {
	$extends : gara.jsface.viewers.ColumnViewer,
	...
	createTreeItem : function (parent, element, index) {
		var item = this.newItem(parent, gara.jswt.JSWT.NULL, index);
	 ...
	 * @private
	 */
	doGetSelection : $abstract(function () {}),
	 ...
	 * @method
	 *
	 * @param {gara.jsface.viewers.ITreeContentProvider} contentProvider
	 */
