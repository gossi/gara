...
$class("Tree", {
	...
	_create : function() {
		...
		// css
		this.setClass("jsWTTreeFullSelection", (this._style & JSWT.FULL_SELECTION) == JSWT.FULL_SELECTION);
		this.setClass("jsWTTreeCheckbox", (this._style & JSWT.CHECK) == JSWT.CHECK);
	...
	handleEvent : function(e) {
		...
		e.item = widget && $class.instanceOf(widget, gara.jswt.widgets.TreeItem) ? widget : this._activeItem;
		e.widget = this;
		this._event = e;
