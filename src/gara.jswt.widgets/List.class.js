...
$class("List", {
	...
	_activateItem : function(item) {
		this.checkWidget();
		if (!$class.instanceOf(item, gara.jswt.widgets.ListItem)) {
	...
	_create : function() {
		...
		// add css classes
		this.setClass("jsWTListFullSelection", (this._style & JSWT.FULL_SELECTION) == JSWT.FULL_SELECTION);
		this.setClass("jsWTListCheckbox", (this._style & JSWT.CHECK) == JSWT.CHECK);
	...
	handleEvent : function(e) {
		...
		e.item = widget && $class.instanceOf(widget, gara.jswt.widgets.ListItem) ? widget : this._activeItem;
		e.widget = this;
		this._event = e;
