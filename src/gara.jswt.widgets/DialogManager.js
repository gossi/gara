...
gara.provide("gara.jswt.widgets.DialogManager");
 ...
 * @private
 */
gara.Class("gara.jswt.widgets.DialogManager", {
...
//		if (!gara.instanceOf(dialog, gara.jswt.Dialog)) {
...
//		}
		...
		if (this._activeDialog != dialog) {
			...
			if ((this._activeDialog.getStyle() & gara.jswt.JSWT.APPLICATION_MODAL) == gara.jswt.JSWT.APPLICATION_MODAL) {
